...
package cl.franciscosolis.simplecoreapi.paper.modules.tasksmodule
...
class PaperTasksModule: Module {


    companion object {
        /**
         * Instance of the [PaperTasksModule].
         */
        lateinit var instance: PaperTasksModule
            private set
    }
    ...
    /**
     * Instance of the [BukkitScheduler] (Bukkit Scheduler)
     */
    val scheduler: BukkitScheduler = Bukkit.getScheduler()

    /**
     * Instance of Paper Loader
     */
    private val plugin = PaperLoader.instance
